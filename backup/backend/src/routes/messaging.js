...
router.get('/conversations', authenticateToken, async (req, res) => {
  try {
    ...
    EnterpriseLogger.error('Get conversations error', error, { userId: req.user.id, ip: req.ip });
...
router.get('/conversations/:id/messages', authenticateToken, async (req, res) => {
  try {
    ...
    EnterpriseLogger.error('Get messages error', error, { userId: req.user.id, conversationId, ip: req.ip });
...
router.post('/conversations/:id/messages', authenticateToken, async (req, res) => {
  try {
    ...
    EnterpriseLogger.info('New message sent', req.user.id, {
    ...
    // Note: Socket.IO integration will be implemented in separate real-time service
    ...
    EnterpriseLogger.error('Send message error', error, { userId: req.user.id, conversationId, ip: req.ip });
...
router.put('/messages/:id/read', authenticateToken, async (req, res) => {
  try {
    ...
    EnterpriseLogger.error('Mark read error', error, { userId: req.user.id, conversationId, ip: req.ip });
...
router.post('/conversations', authenticateToken, async (req, res) => {
  try {
    ...
    EnterpriseLogger.error('Create conversation error', error, { userId: req.user.id, participantIds: req.body.participantIds, ip: req.ip });
...
router.put('/conversations/:id/read', authenticateToken, async (req, res) => {
  try {
    ...
    EnterpriseLogger.error('Mark conversation read error', error, { userId: req.user.id, conversationId, ip: req.ip });
...
router.get('/unread-count', authenticateToken, async (req, res) => {
  try {
    ...
    EnterpriseLogger.error('Get unread count error', error, { userId: req.user.id, ip: req.ip });
...
router.delete('/messages/:id', authenticateToken, async (req, res) => {
  try {
    ...
    EnterpriseLogger.error('Delete message error', error, { userId: req.user.id, messageId, ip: req.ip });
...
router.put('/conversations/:id/block', authenticateToken, async (req, res) => {
  try {
    ...
    EnterpriseLogger.error('Block user error', error, { userId: req.user.id, blockedUserId, ip: req.ip });
...
router.get('/conversations/:id/stats', authenticateToken, async (req, res) => {
  try {
    ...
    EnterpriseLogger.error('Get conversation stats error', error, { userId: req.user.id, ip: req.ip });
